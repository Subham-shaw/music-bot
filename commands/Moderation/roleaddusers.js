...
module.exports = {
    name: `roleaddusers`,
    description: `Add a particular role to all the users in the server`,
    category: `Moderation`,
    options: [
        {
            name: `role`,
    ...
    run: async (client, interaction) => {
        ...
        switch (error) {
            ...
            case false:
                let em = new EmbedBuilder().setColor(client.ee.color).setTitle(`${client.em.yes} Role Added to ${members.size} Users`)
