...
module.exports = {
    name: `roleremovebots`,
    description: `Removes a particular role Form all the bots in the server`,
    category: `Moderation`,
    options: [
        {
            name: `role`,
    ...
    run: async (client, interaction) => {
        ...
        switch (error) {
            ...
            case false:
                let em = new EmbedBuilder().setColor(client.ee.color).setTitle(`${client.em.yes} Role Removed from ${members.size} Bots`)
